...
import { TracingBeamDemoWax } from "@/components/ManSection/Waxing";
  ...
  return (
    <div className="flex  w-full items-center flex-col gap-1  bg-zinc-900 px-3 py-6">
      <div className="w-full mt-10 mb-4 text-center">
        <span className="text-yellow-400 text-2xl font-medium">Sophisticated Male Waxing</span> <br />
        <span className="text-zinc-500 text-lg  font-semibold">Elite Hair & Waxing Services</span>
      </div>
