...
import Beard from "@/components/ManSection/Beard";
  ...
  return (
    <div className="flex  w-full items-center flex-col gap-1  bg-zinc-900 px-3 py-6">
      <div className="w-full mt-10 mb-4 text-center">
        <span className="text-yellow-400 text-2xl font-medium">Professional Trimming Services for Men</span> <br />
        <span className="text-zinc-500 text-base px-3 font-semibold">Beard, Mustache, Neckline, Sideburn, Hairline & Eyebrow Trimming</span>
      </div>
