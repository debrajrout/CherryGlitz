...
import Kids from "@/components/ManSection/Kids";
      ...
      <section className=" text-white">
        <div className="mx-auto max-w-screen-xl px-4 pt-12 pb-4 lg:flex lg:h-screen lg:items-center">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Cherry Glitch: Expert Child Services


            </h1>

            <p className="mx-auto text-xs text-gray-400 mt-4 max-w-xl sm:text-xl/relaxed">
              Discover our professional services tailored for children. From haircuts and styling to safe ear piercing, we ensure your child looks and feels their best.
            </p>
